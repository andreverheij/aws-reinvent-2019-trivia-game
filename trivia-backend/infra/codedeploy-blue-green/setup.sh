...
aws cloudformation deploy --region ap-southeast-2 --template-file packaged-template.yaml --stack-name TriviaBackendHooksTest --capabilities CAPABILITY_IAM --parameter-overrides TriviaBackendDomain=api-test.dev.dezignit.com

aws cloudformation deploy --region ap-southeast-2 --template-file packaged-template.yaml --stack-name TriviaBackendHooksProd --capabilities CAPABILITY_IAM --parameter-overrides TriviaBackendDomain=api.dev.dezignit.com
