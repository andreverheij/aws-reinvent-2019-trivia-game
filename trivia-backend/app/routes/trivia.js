 ...
 *     curl -i https://api.trivia.aws.sydney.edu.au/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.trivia.aws.sydney.edu.au/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.trivia.aws.sydney.edu.au/api/trivia/question/1
 */
