 ...
 *     curl -i https://api.dev.dezignit.com/api/trivia/all
 */
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i https://api.dev.dezignit.com/api/trivia/question/1
 */
 ...
 *          -d "{'answer' : 'Broomball'}" \
 *          -X POST https://api.dev.dezignit.com/api/trivia/question/1
 */
